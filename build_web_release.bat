...
set EMSCRIPTEN_SDK_DIR=c:\dev\compilers\emscripten\emsdk
...
set files=%OUT_DIR%\game.wasm.o %ODIN_PATH%\vendor\raylib\wasm\libraylib.a %ODIN_PATH%\vendor\raylib\wasm\libraygui.a source\box2d\lib\box2d_wasm.o source\clay-odin\wasm\clay.o

:: index_template.html contains the javascript code that calls the procedures in
:: source/main_web/main_web.odin
set flags=-sUSE_GLFW=3 -sWASM_BIGINT -sWARN_ON_UNDEFINED_SYMBOLS=0 -sASSERTIONS --shell-file source\main_web\index_template.html --preload-file assets -sINITIAL_MEMORY=209715200 -sSTACK_SIZE=200000 -sALLOW_MEMORY_GROWTH
